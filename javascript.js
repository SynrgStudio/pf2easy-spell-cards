	...
	mutations.forEach(function (mutation) {
		...
		if (!fired && ready) {
			...
			document.querySelector("button#cards_btn").addEventListener('click', function () {
				this.disabled = true;
				let script_one_time = document.createElement('script'); script_one_time.src = "https://cdn.jsdelivr.net/gh/SynrgStudio/pf2easy-spell-cards@main/one-time-insert.js"; document.querySelector('head').appendChild(script_one_time);
			}, false);
		}
	});
});
